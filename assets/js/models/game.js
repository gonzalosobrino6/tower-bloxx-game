...
Game.prototype.moveAll = function () {
    ...
    if(this.boxes.length <= 1 && this.boxes != "") {
        ...
        if(this.boxes[this.boxes.length - 1].y + 50 > this.boxes[this.boxes.length - 2].y) {
            this.boxes[this.boxes.length - 1].y = this.boxes[this.boxes.length - 2].y - 50;// this y < this.y -1 --> v = 0
        }
...
Game.prototype.hasCollision = function () {
    ...
    if (this.boxes != "") {
        if (this.penultimateBloxx1.x < this.lastBloxx2.x && 
            this.lastBloxx2.x < this.penultimateBloxx1.x + this.penultimateBloxx1.w ||
            this.penultimateBloxx1.x - this.penultimateBloxx1.w < this.lastBloxx2.x &&
